...
Partial Class ManageScreenshots_old
    ...
    Protected Sub bindGridview(ByVal all As Boolean)
        ...
        Try
            ...
            strSQL = "SELECT Images.*, Projects.ProjectName FROM Projects INNER JOIN Images ON Projects.ID = Images.ProjectID"
            ...
            If Not all Then
                ...
                If Session("Project") IsNot Nothing Then
                    ...
                    strSQL &= " Images.ProjectID = @ProjectID"
    ...
    Public Function formatImage(ByVal img As Object, ByVal resized As Object) As String
        Dim image As Image = getImage(img)
        Dim returnStr As String = ""

        If resized Then
            returnStr = img & " <span style='color: #9c9172;'>[Resized]</span>"
        ElseIf image.Width > 600 Then
            returnStr = img & " <span class='ResizableStyle'>[*]</span>"
        End If
        Return returnStr
    End Function

    Private Function getImage(ByVal imgStr As String) As Image
        Dim img As Image = Image.FromFile(Page.MapPath("..") & "\screens\" & imgStr)
        Return img
    End Function
