<%@ Page Title="Zogglet.com - The domain of Maggy Maffia &raquo; Manage Screenshots" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="ManageScreenshots_old.aspx.vb" Inherits="ManageScreenshots_old" %>
                ...
                <asp:UpdatePanel ID="images_updatePnl" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="images_gv" runat="server" AutogenerateColumns="false" GridLines="None" Width="675px" DataKeyNames="ID"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Image" SortExpression="Path" ItemStyle-CssClass="GVButtonItemStyle">
                                    <ItemTemplate>
                                        <asp:LinkButton id="image_lBtn" runat="server" CommandName="Select" Text='<%#formatImage(eval("Path"), eval("Resized"))%>' />
                                        ...
                                        <asp:Panel ID="img_pnl" runat="server">
                                            <asp:Image ID="gv_img" runat="server" ImageUrl='<%# "../screens/" & Eval("Path") %>' Width="150px" BorderColor="#393426" BorderStyle="Solid" BorderWidth="1px" />
                                        </asp:Panel>
